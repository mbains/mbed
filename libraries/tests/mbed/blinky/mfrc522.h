 ...
 * Author: mbai
 *
 * Created on December 7, 2015, 5:02 PM
 */
...
public:
	...
	MFRC522::StatusCode PCD_CalculateCRC(uint8_t *data, uint8_t length, uint8_t *result);
	...
	/////////////////////////////////////////////////////////////////////////////////////
	MFRC522::StatusCode PCD_TransceiveData(uint8_t *sendData, uint8_t sendLen, uint8_t *backData, uint8_t *backLen, uint8_t *validBits = NULL, uint8_t rxAlign = 0, bool checkCRC = false);
	MFRC522::StatusCode PCD_CommunicateWithPICC(uint8_t command, uint8_t waitIRq, uint8_t *sendData, uint8_t sendLen, uint8_t *backData = NULL, uint8_t *backLen = NULL, uint8_t *validBits = NULL, uint8_t rxAlign = 0, bool checkCRC = false);
	MFRC522::StatusCode PICC_RequestA(uint8_t *bufferATQA, uint8_t *bufferSize);
	MFRC522::StatusCode PICC_WakeupA(uint8_t *bufferATQA, uint8_t *bufferSize);
	MFRC522::StatusCode PICC_REQA_or_WUPA(uint8_t command, uint8_t *bufferATQA, uint8_t *bufferSize);
	MFRC522::StatusCode PICC_Select(Uid *uid, uint8_t validBits = 0);
	MFRC522::StatusCode PICC_HaltA();
	
	/////////////////////////////////////////////////////////////////////////////////////
	// Functions for communicating with MIFARE PICCs
	/////////////////////////////////////////////////////////////////////////////////////
	MFRC522::StatusCode PCD_Authenticate(uint8_t command, uint8_t blockAddr, MIFARE_Key *key, Uid *uid);
	void PCD_StopCrypto1();
	MFRC522::StatusCode MIFARE_Read(uint8_t blockAddr, uint8_t *buffer, uint8_t *bufferSize);
	MFRC522::StatusCode MIFARE_Write(uint8_t blockAddr, uint8_t *buffer, uint8_t bufferSize);
	MFRC522::StatusCode MIFARE_Ultralight_Write(uint8_t page, uint8_t *buffer, uint8_t bufferSize);
	MFRC522::StatusCode MIFARE_Decrement(uint8_t blockAddr, long delta);
	MFRC522::StatusCode MIFARE_Increment(uint8_t blockAddr, long delta);
	MFRC522::StatusCode MIFARE_Restore(uint8_t blockAddr);
	MFRC522::StatusCode MIFARE_Transfer(uint8_t blockAddr);
	MFRC522::StatusCode MIFARE_GetValue(uint8_t blockAddr, long *value);
	MFRC522::StatusCode MIFARE_SetValue(uint8_t blockAddr, long value);
