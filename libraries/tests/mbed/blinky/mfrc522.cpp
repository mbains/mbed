 ...
 * @return STATUS_OK on success, STATUS_??? otherwise.
  */
MFRC522::StatusCode MFRC522::MIFARE_GetValue(uint8_t blockAddr, long *value) {
	MFRC522::StatusCode status;
	uint8_t buffer[18];
 ...
 * @return STATUS_OK on success, STATUS_??? otherwise.
 */
MFRC522::StatusCode MFRC522::MIFARE_SetValue(uint8_t blockAddr, long value) {
	uint8_t buffer[18];
 ...
 * @return PICC_Type
 */
MFRC522::PICC_Type MFRC522::PICC_GetType(uint8_t sak		///< The SAK byte returned from PICC_Select().
										) {
